        ...
        <div>
            ...
            <List>
                {Object.keys(routes).map((item) => (
                    <MuiLink underline="none" classes={{root: classes.link, onClick: classes.selected}} component={NavLink} onClick={() => {setCurrentPath(routes[item].path); handleDrawerToggle()}} to={routes[item].path}>
